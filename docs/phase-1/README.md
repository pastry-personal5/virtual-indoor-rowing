...
Status: Open (per [ADR-0010](../adr/0010-defer-remaining-phase-0-spike-evidence-to-phase-4.md), 2026-09-17); milestones are scoped one at a time, immediately before each one's implementation — Milestone 1 is scoped and implemented (see [01-milestone-1-rowingcore-domain-contract.md](01-milestone-1-rowingcore-domain-contract.md)); Milestone 2 is scoped and implemented, real-PM5 confirmation outstanding (see [02-milestone-2-device-capability-handshake.md](02-milestone-2-device-capability-handshake.md)); Milestone 3 is scoped and implemented (see [03-milestone-3-local-data-session-journal.md](03-milestone-3-local-data-session-journal.md)); Milestone 4 is scoped and implemented, real-PM5 confirmation outstanding (see [04-milestone-4-workout-runtime.md](04-milestone-4-workout-runtime.md)); Milestone 5 (simulator-driven Unreal integration and HUD) is scoped and implemented, owner-confirmed in the packaged app (see [05-milestone-5-unreal-hud.md](05-milestone-5-unreal-hud.md)); Milestone 6 (hardening, refactor, and chores) is scoped and implemented (see [06-milestone-6-hardening-and-refactor.md](06-milestone-6-hardening-and-refactor.md)); Milestone 7 (real PM5 wiring in the app) is scoped and implemented, real-PM5 confirmation outstanding (see [07-milestone-7-real-pm5-app-wiring.md](07-milestone-7-real-pm5-app-wiring.md))
