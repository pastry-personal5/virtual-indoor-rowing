...
`Source/RowingSim` implements the transport-neutral device interface first, plus a CoreBluetooth peripheral simulator where practical. Scenarios are declarative and seeded:
